        ...
        <a class="navbar-brand" href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#biblioteca">Historial</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#docentes">Lista Asignaturas</a>
                    </li>
                </ul>
            </div>
        </div>
         ...
         <div class="table-container">
             ...
             <table class="table table-dark table-striped" id="Table">
                 <thead>
                   ...
                   <tbody>
                     <tr>
                       <th scope="row">IS802</th>
                       <td>Ingenieria de Software</td>
                       <td>1100</td>
                       <td>100</td>
                     </tr>
                     <tr>
                       <th scope="row">IS601</th>
                       <td>Base de DatosII</td>
                       <td>1800</td>
                       <td>100</td>
                     </tr>
                     <tr>
                       <th scope="row">IS820</th>
                       <td>Finanzas Asministrativas</td>
                       <td>1400</td>
                       <td>100</td>
                     </tr>
                   </tbody>
